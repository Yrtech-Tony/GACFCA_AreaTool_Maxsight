...
namespace FIAT.Web.Common
{
    ...
    {
        private readonly string _appKey = "3JkljJxvXgjLz80X";
        private readonly string _appSecret = "L2ERHORPk3WkjqfGUb27RlxvT8x5f3";
        ...
        public string SmsType { get; set; } = "短信通知";
        public string SmsFreeSignName { get; set; } = "消息提醒";
        public string SmsParam { get; set; }
        public string RecNum { get; set; } = "18518509044";
        public string SmsTemplateCode { get; set; } = "SMS_142954674";
