...
namespace FIAT.Web.Common
{
    ...
    public class PermissionRequiredAttribute : ActionFilterAttribute
    {
        ...
        private bool HasAccessRight(ActionExecutingContext context, string controllerName, string actionName)
        {
            ...
            string roleListStr = context.HttpContext.Request.Cookies["fiat_ROLELIST1"] + context.HttpContext.Request.Cookies["fiat_ROLELIST2"] + context.HttpContext.Request.Cookies["fiat_ROLELIST3"];
