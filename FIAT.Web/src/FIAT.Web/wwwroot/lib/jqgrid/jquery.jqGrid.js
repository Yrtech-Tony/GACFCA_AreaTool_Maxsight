// @reference ~/Scripts/Public/jquery-1.8.1.js
// @reference ../css/ui.jqgrid-custom.css
...
(function ($) {
    ...
    $.fn.jqGrid = function (pin) {
		...
		setPager = function (pgid, tp) {
		    ...
		    $("#" + $.jgrid.jqID(pgid))
		    //todo:由于table-layout:fixed 的样式 会使page中的按钮被页码小区遮住，所以进行了修改
            .append("<div id='" + pgcnt + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:auto;height:100%;' role='row'><tbody><tr><td id='" + lft + "' align='left'></td><td id='" + cent + "' align='center' style='white-space:pre;'></td><td id='" + rgt + "' align='right'></td></tr></tbody></table></div>")
		...
		firstr = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
            ...
            $("th", thr).each(function (j) {
                ...
                //TODO: MDFY:jin.chunhe MODI-DATE:2014-09-27 DESC: add nm == 'chk' condition
                if (!(nm === 'cb' || nm === 'subgrid' || nm === 'rn' || nm === 'chk')) {
        ...
        setFrozenColumns: function () {
            return this.each(function () {
				...
				htoh = $(".ui-jqgrid-hdiv", "#gview_" + $.jgrid.jqID($t.p.id)).outerHeight();
                    ...
                    }//TODO:remove fhDiv height Modifier:jin.chunhe ModiDate:2014-09-15
...
(function ($) {
    ...
    */
    ...
    $.extend($.jgrid, {
        ...
        createEl: function (eltype, options, vl, autowidth, ajaxso) {
            ...
            switch (eltype) {
                case "textarea":
                    ...
                    if (autowidth) {
                        //TODO:MDFY:jin.chunhe DATE:2014-10-09 DESC:set textbox width as 100%
                        if (!options.cols) { $(elem).css({ width: "100%" }); }
		...
		tsp = {}, sep;
        //TODO:MDFY:jin.chunhe MODI_DT:14-09-26 DESC:check 'Y-m-d' format
            ...
            for (i = 0; i < format.length; i++) {
                ...
                yln = format[i];
                //TODO:MDFY:jin.chunhe MODI_DT:14-09-26 DESC:check 'Y-m-d' format
                if (yln.indexOf("Y") !== -1 || yln.indexOf("y") !== -1) { j = i; }
                if (yln.indexOf("m") !== -1) { mln = i; }
                if (yln.indexOf("d") !== -1) { dln = i; }
            }
            //TODO: MODIFYER:jin.chunhe, MODI_DATE:2014.09.26
            // 'y' 를 'Y'로 수정
		    if (format[j] === "Y" || format[j] === "yyyy") {
			    yln=4;
            //'y'를 추가
		    } else if(format[j] ==="y" || format[j] ==="yy") {
                yln = 2;
            } else {
                yln = -1;
            }
        ...
        saveCell: function (iRow, iCol) {
            return this.each(function () {
				...
				cm = $t.p.colModel[iCol], nm = cm.name, nmjq = $.jgrid.jqID(nm);
                    ...
                    //TODO:MDFY:jin.chunhe MODI-DATE:2014-09-27 DESC:add v2 ==='' condition
                    if (v2 ==='' || v2 !== $t.p.savedRow[fr].v) {
                        ...
                        if (cv[0] === true) {
                            ...
                            try {
//                            var aaa = $("td:eq(" + iCol + ")", $t.rows[iRow])
//                            .popover({title:false,content:cv[1],trigger:"manual"})
//                            .popover("show");
                                window.setTimeout(function () { 
//                                aaa.popover("hide");
                                //TODO: MODIFIER:jin.chunhe MODI-DATE:2014-09-25 DESC: modify alert function 
                                 //var aaa = $("td:eq(" + iCol + ")", $t.rows[iRow]).tooltip({title:'afadsf',trigger:'manual'}).tooltip('show');
//                                 aaa.tooltip({
//                                    title:"adfasdfa",
//                                    trigger:'manual',
//                                    html:true
...
$(document).on("click",".jqgrid-detail-btn",function(){
    var currentRow = $(this).parents("tr:first");
    currentRow.addClass("currentDetailGrid");
    currentRow.siblings().removeClass("currentDetailGrid");
});
