...
function makeXworksheet() {
  ...
  sheet.sheetPr = new XsheetPr({ filterMode: false }, [new XpageSetUpPr({ fitToPage: true })]);
  sheet.sheetViews = new XsheetViews({}, [new XsheetView({
    colorId: 64,
    defaultGridColor: true,
    rightToLeft: false,
    showFormulas: false,
    showGridLines: _showYN,
...
var Sheet = function () {
  ...
  _createClass(Sheet, [{
    ...
    value: function makeXSheet(refTable, styles) {
      ...
      key: 'setShowGridLine',
      value: function setShowGridLine(showYN) {
          _showYN = showYN;
      }

  }, {
      key: 'setOrientation',
      value: function setOrientation(orien) {
          _orien = orien;
      }
